...
PAGE_REGISTRY: list[dict] = [
    ...
    {"name": "Market Pulse",     "file": "app/pages/01_📡_Market_Pulse.py",     "tabs": 0,  "timeout": 45},
    {"name": "Sector Analysis",  "file": "app/pages/02_📈_Sector_Analysis.py",  "tabs": 4,  "timeout": 30},
    {"name": "Index Stocks",     "file": "app/pages/03_🏛️_Index_Stocks.py",    "tabs": 3,  "timeout": 30},
    {"name": "FII DII Flow",     "file": "app/pages/04_🏦_FII_DII_Flow.py",     "tabs": 2,  "timeout": 20},
    {"name": "FII Sectors",      "file": "app/pages/05_🏢_FII_Sectors.py",      "tabs": 2,  "timeout": 30},
    {"name": "FPI Sectors",      "file": "app/pages/06_🌏_FPI_Sectors.py",      "tabs": 6,  "timeout": 20},
    {"name": "Stock Picker",     "file": "app/pages/07_🎯_Stock_Picker.py",     "tabs": 2,  "timeout": 30},
    {"name": "Smart Money",      "file": "app/pages/08_💰_Smart_Money.py",      "tabs": 3,  "timeout": 40},
    {"name": "FII Accumulation", "file": "app/pages/09_📊_FII_Accumulation.py", "tabs": 0,  "timeout": 30},
    {"name": "Bulk Deals",       "file": "app/pages/10_📑_Bulk_Deals.py",       "tabs": 2,  "timeout": 20},
    {"name": "Alerts",           "file": "app/pages/11_🔔_Alerts.py",           "tabs": 3,  "timeout": 240},
    {"name": "HM Scanner",       "file": "app/pages/12_🔭_HM_Scanner.py",       "tabs": 0,  "timeout": 90},
    ...
    {"name": "AI Forecast",      "file": "app/pages/15_🤖_AI_Forecast.py",      "tabs": 0,  "timeout": 30},
    {"name": "Gann Analysis",    "file": "app/pages/16_🔢_Gann_Analysis.py",    "tabs": 0,  "timeout": 45},
    {"name": "Export",           "file": "app/pages/17_📤_Export.py",           "tabs": 0,  "timeout": 20},
    {"name": "Contact",          "file": "app/pages/18_📧_Contact.py",          "tabs": 0,  "timeout": 15},
    {"name": "Disclaimer",       "file": "app/pages/19_⚖️_Disclaimer.py",      "tabs": 0,  "timeout": 15},
    {"name": "Paper Trading",    "file": "app/pages/22_💹_Paper_Trading.py",    "tabs": 3,  "timeout": 20},
    {"name": "Pricing",          "file": "app/pages/24_💎_Pricing.py",          "tabs": 0,  "timeout": 20},
    {"name": "My Profile",       "file": "app/pages/25_👤_My_Profile.py",       "tabs": 0,  "timeout": 20},
    {"name": "Momentum Scanner", "file": "app/pages/26_🚀_Momentum_Scanner.py", "tabs": 3,  "timeout": 120},
    # Admin (20_🔐_Admin.py) excluded — it's the test runner itself
    # User Guide (21_📖_User_Guide.py) excluded — static content, no backend calls to test
    # User Management (23_👥_User_Management.py) excluded — same reason as Admin
]
