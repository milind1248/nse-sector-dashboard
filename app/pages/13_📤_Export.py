...
| 12_Gann_Analysis | Gann cache — ATR consumed %, degree levels, Price-Time square, natural date hit rate per stock |
| 13_AI_Forecast_Signals | Prophet trend + XGBoost direction for all dashboard stocks |
""")
