...
k4.metric("Top Buyer",  top_buy["nsdl_sector"][:20],  f"₹{top_buy['net_curr_eq']:+,.0f} Cr", delta_color="normal")
k5.metric("Top Seller", top_sell["nsdl_sector"][:20], f"₹{top_sell['net_curr_eq']:+,.0f} Cr", delta_color="normal")
...
with tab_net:
    ...
    if not bar_vals:
        ...
        s1.metric("Cumulative Net",   f"₹{cum_vals[-1]:+,.0f} Cr", f"₹{cum_vals[-1]:+,.0f} Cr", delta_color="normal")
